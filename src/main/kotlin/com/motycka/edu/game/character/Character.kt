    ...
    fun validate() {
        ...
        when (characterClass) {
            CharacterClass.WARRIOR -> {
                ...
                require(mana == null && healingPower == null) {
                    "Warriors cannot have mana or healing power"
                }
                require(stamina > 0 && defensePower >= 0) {
                    "Invalid Warrior attributes"
                }
            }
            CharacterClass.SORCERER -> {
                ...
                require(stamina == null && defensePower == null) {
                    "Sorcerers cannot have stamina or defense power"
                }
                require(mana > 0 && healingPower >= 0) {
                    "Invalid Sorcerer attributes"
                }
            }
        }

        val totalPoints = health + attackPower + (stamina ?: 0) +
                (defensePower ?: 0) + (mana ?: 0) + (healingPower ?: 0)
